...
/*   Updated: 2022/05/17 10:57:32 by rel-hach         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_message_status(int sig)
{
	if (sig == SIGUSR1)
		ft_putstr_fd("message has been successfully sent", 1);
}
...
int	main(int ac, char **av)
{
	...
	i = 0;
	sa.sa_handler = ft_message_status;
